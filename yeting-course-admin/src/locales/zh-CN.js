...
export default {
  ...
  'menu.account': '账号管理',
  'menu.account.account-list': '账号列表',
  'menu.account.my-account': '我的账号',
  'menu.account.settings': '个人设置',
  'menu.account.trigger': '触发报错',
  'menu.account.logout': '退出登录',
  'menu.task': '档案管理',
  'menu.task.task-list': '档案列表',
  ...
  'menu.course': '课程管理',
  'menu.course.course-list': '课程列表',
  'menu.audio': '音频管理',
  'menu.audio.audio-list': '音频列表',
  'menu.user': '用户管理',
  'menu.user.user-list': '用户列表',
  'menu.data': '数据统计',
  'menu.data.message-list': '消息推送数据统计',
